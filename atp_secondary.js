...
function aOpenQueriesPanel(presetUid,presetName){
  ...
  if(!m){
    ...
    threadWrap.style.cssText='flex:2 1 300px;display:flex;flex-direction:column;min-width:0';
    ...
    thread.style.cssText='flex:1;overflow-y:auto;padding:.7rem;font-size:.78rem';
