...
function aOpenQueriesPanel(presetUid,presetName){
  ...
  if(!m){
    ...
    var box=document.createElement('div');
    box.style.cssText='background:#fff;border-radius:14px;max-width:760px;width:100%;overflow:hidden;box-shadow:0 24px 60px rgba(0,0,0,.4);max-height:88vh;display:flex;flex-direction:column';
    var hdr=document.createElement('div');
    ...
    panes.style.cssText='display:flex;flex-wrap:wrap;flex:1;min-height:340px;max-height:70vh;overflow:hidden';
    var listPane=document.createElement('div');
    listPane.id='aQryUserList';
    listPane.style.cssText='flex:1 1 200px;max-width:230px;overflow-y:auto;border-right:1px solid #eee;padding:.5rem';
    listPane.innerHTML='Loading...';
    var threadWrap=document.createElement('div');
    threadWrap.style.cssText='flex:2 1 300px;display:flex;flex-direction:column;min-width:0;min-height:0';
